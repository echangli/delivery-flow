...
digraph delivery {
  ...
  subgraph cluster_a {
    ...
    a0 -> a1 -> a2 -> a3 -> a4 -> a5 -> a5b -> a5c -> a5d -> a6 -> a7 -> a7b -> a8;
  }
...
стандарта, слова — зона линтера копи, процесс/инфра/команды/гейты (worktree, green-sequence, dev-server,
